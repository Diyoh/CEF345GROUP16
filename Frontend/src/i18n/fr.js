...
export const fr = {
    ...
    home: {
        ...
        moneyTitle: "L'argent, {year}",
        moneyLead: "Ce qui a été alloué, ce qui est arrivé, et ce qui a été versé dans les caisses.",
        moneyCta: "Explorer l'argent",
        moneyLedgerNote: 'Chaque chiffre est inscrit au registre public signé.',
    ...
    publicMoney: {
        title: "L'argent",
        lead: "Chaque allocation budgétaire à chaque ministère et commune, et ce que chaque institution a versé dans les caisses de l'État, pour l'année de votre choix. Chaque chiffre est inscrit au registre public signé.",
        yearLabel: 'Exercice',
        totalAllocated: 'Alloué au total',
        totalSent: 'Envoyé au total',
        totalConfirmed: 'Réception confirmée',
        totalIncome: 'Versé dans les caisses',
        registerTitle: 'Allocations budgétaires, {year}',
        registerLead: "Ce que le ministère des Finances a engagé pour chaque institution, ce qu'il a réellement envoyé, et ce que l'institution a confirmé avoir reçu. Les noms ouvrent la page de l'institution.",
        receiver: 'Institution',
        committed: 'Engagé',
        sent: 'Envoyé',
        confirmed: 'Confirmé',
        noAllocations: 'Aucune allocation enregistrée pour {year}',
        noAllocationsBody: "Quand le ministère des Finances engage de l'argent pour cette année, le registre apparaît ici.",
        coffersTitle: 'Versé dans les caisses, {year}',
        coffersLead: "Les recettes que chaque ministère et commune a enregistrées de ses propres sources : taxes, droits, subventions. Ligne par ligne, pour qu'un total ne soit jamais une boîte noire.",
        noIncome: 'Aucune recette enregistrée pour {year}',
        noIncomeBody: 'Quand une institution enregistre des recettes pour cette année, elles apparaissent ici.',
        failed: "La page de l'argent n'a pas pu charger",
    ...
    trail: {
        ...
        summary: '{paid} déclarés payés, {affirmed} attestés reçus',
        noPayments: "Aucun paiement n'a encore été enregistré pour cet entrepreneur. Quand l'institution propriétaire paie, l'enregistrement apparaît ici et l'entrepreneur doit attester ce qui est arrivé.",
        awaiting_one: "{count} paiement attend l'entrepreneur.",
        awaiting_other: "{count} paiements attendent l'entrepreneur.",
        ledgerNote: 'Chaque étape ci-dessus est inscrite au registre public signé.',
        ledgerLink: 'Vérifiez-le vous-même',
    },

    ledger: {
        title: 'Le registre public',
        lead: "Chaque action financière de cette plateforme est inscrite dans un registre signé, chaîné par hachage, en écriture seule. Cette page ne vous demande pas de le croire ; elle vous montre comment le vérifier.",
        headTitle: 'La tête de chaîne',
        headLead: "L'empreinte de toute l'histoire. Notez-la : si un enregistrement passé est un jour modifié ou supprimé, ce nombre change et ne correspond plus à votre copie.",
        copyHead: 'Copier la tête',
        copiedToast: 'Tête de chaîne copiée. Gardez-la quelque part chez vous.',
        verifyTitle: 'Vérifier la chaîne',
        verifyLead: 'Exécute le contrôle complet : chaque entrée rehachée, chaque lien vers la précédente confirmé, chaque signature validée avec la clé de signature.',
        verifyNow: 'Vérifier la chaîne maintenant',
        verdictOk_one: 'Chaîne intacte. {count} entrée vérifiée de bout en bout.',
        verdictOk_other: 'Chaîne intacte. Les {count} entrées vérifiées de bout en bout.',
        verdictBroken: "CHAÎNE ROMPUE à l'entrée {seq}. Considérez chaque chiffre comme suspect.",
        verifyFailed: "La vérification n'a pas pu s'exécuter",
        feedTitle: "Le registre, tel qu'il s'écrit",
        feedLead: 'Les entrées les plus récentes, de la plus neuve à la plus ancienne. Chacune porte le hachage qui la chaîne à tout ce qui précède.',
        feedFootnote: "Les entrées ne peuvent être ni modifiées ni supprimées, par la base de données elle-même. Un rechargement des données de démonstration s'ajoute par-dessus l'histoire ; rien n'est jamais effacé.",
        empty: 'Le registre est vide',
        emptyBody: "La première action financière écrira l'entrée nº1, chaînée à la constante publique de genèse.",
        type_allocation_created: 'Budget alloué',
        type_disbursement_sent: 'Argent envoyé',
        type_disbursement_confirmed: 'Réception confirmée',
        type_budget_set: 'Budget déclaré',
        type_budget_revised: 'Budget révisé',
        type_income_recorded: 'Recette enregistrée',
        type_payment_initiated: 'Entrepreneur payé',
        type_payment_affirmed: 'Paiement attesté',
        type_contractor_verified: 'Entrepreneur vérifié',
        type_contractor_rejected: 'Entrepreneur rejeté',
    },
